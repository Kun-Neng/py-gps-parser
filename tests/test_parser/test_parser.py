...
normal_GGA = '$GNGGA,062354.00,2451.76046,N,12115.52146,E,1,05,2.04,254.5,M,16.7,M,,*42'
...
final_normal_message = \
'$GNRMC,062354.00,A,2451.76046,N,12115.52146,E,0.134,,231221,,,A*6C' \
'$GNVTG,,T,,M,0.134,N,0.248,K,A*35' \
'$GNGGA,062354.00,2451.76046,N,12115.52146,E,1,05,2.04,254.5,M,16.7,M,,*42' \
...
def test_parse_NMEA():
    ...
    assert parser.parse_NMEA(final_normal_message) == True
